...
b},r.width=r.height=function(a,b){if(""===b)return a.setAttribute(name,"auto"),b});e.style||(r.style=function(a,b){return a.style.cssText=""+b});return function(e,b){var f=h.createElement(e),p,c;if(g.hasOwn(b,"innerHTML")){q(f,b.innerHTML);delete b.innerHTML}for(p in b){c=b[p];if(m[p])f["on"+p]=c;else{var k=f,s=p;if("getAttribute"in k){var u=void 0,s=a[s]||s,u=r[s];if(!u)if(t.test(s))u=i;else if(l&&s!="className"&&(k.nodeName&&k.nodeName.toUpperCase()=="FORM"||w.test(s)))u=l;c!==void 0&&!(u&&u(k,
c,s)!==void 0)&&k.setAttribute(s,""+c)}else{s=d[s]||s;c!==void 0&&(k[s]=c)}}}return f}}();d.addMode({name:"dom",createElement:function(a,d,e){var l=g.hasOwn(d,"innerHTML"),a=i(a,d);if(!l)for(var l=0,d=e.length,m;l<d;l++)(m=e[l])&&m.nodeType?a.appendChild(m):a.appendChild(h.createTextNode(""+m));return a},textNode:function(a){return h.createTextNode(a)},fragment:function(a){for(var d=h.createDocumentFragment(),e=0,g=a.length,i;e<g;e++)i=a[e],i.nodeType?d.appendChild(i):d.appendChild(h.createTextNode(""+
i));return d},isModeObject:function(a){return!!a.nodeType},api:{createElement:i}})});m.define("./dombuilder/html",function(d,e,a){function g(a){this.value=a}function h(a){return new g(a)}function m(a){return a instanceof g}function q(a){return a instanceof g?a.value:b(""+a)}function i(a){this.childNodes=a||[];this._inlineFragments();this.firstChild=this.childNodes.length?this.childNodes[0]:null}function j(a,b,c){i.call(this,c);this.tagName=this.nodeName=a.toLowerCase();this.attributes=b||{}}function n(a){i.call(this,
