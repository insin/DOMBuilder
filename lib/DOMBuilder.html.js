...
MockElement.prototype._clone = function() {
  var clone = new MockElement(this.tagName, extend({}, this.attributes));
  clone.xhtml = this.xhtml;
  return clone;
};

/**
 * Creates an HTML/XHTML representation of an MockElement.
 *
...
/**
 * Creates an HTML/XHTML representation of an MockFragment.
 *
