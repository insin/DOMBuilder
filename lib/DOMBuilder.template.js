...
function getTemplate(name) {
  if (typeof templates[name] == 'undefined') {
    throw new TemplateNotFoundError("Could not find a template named '" +
                                    name + '"');
  }
 ...
 *
 * Each block in a template being rendered is added to a First In First Out
 * queue spcific to its block name. As rendering walks up through the
 * inheritance hierarchy, the blocks which were most deeply overridden will be
 * at the head of their respective queues when the top-most template starts
 * rendering block contents.
 */
